        ...
        <div className="flex-shrink-0 p-4 md:p-6">
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <BankLogo3D size={50} />
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white drop-shadow-lg">Memory Game</h1>
                <p className="text-secondary text-sm md:text-base">Найди все пары карточек</p>
              </div>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 shadow-2xl">
              <div className="flex justify-around items-center">
                <div className="text-center">
                  ...
                  <div className="text-xs md:text-sm text-white/60 uppercase tracking-wider">Ходов</div>
                </div>
                <div className="w-px h-12 bg-white/20"></div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-secondary drop-shadow">{formatTime(time)}</div>
                  <div className="text-xs md:text-sm text-white/60 uppercase tracking-wider">Время</div>
                </div>
                <div className="w-px h-12 bg-white/20"></div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-green-400 drop-shadow">{matched.length / 2}/{cards.length / 2}</div>
                  <div className="text-xs md:text-sm text-white/60 uppercase tracking-wider">Найдено</div>
                </div>
                ...
                <div className="text-center hidden md:block">
                  ...
                  <div className="text-xs text-white/60 uppercase tracking-wider">Рекорд</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center p-4 overflow-auto">
          {gameWon ? (
            <div className="text-center animate-fade-in">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 drop-shadow-lg">Победа!</h2>
              <p className="text-xl text-white/80 mb-2">Вы нашли все пары!</p>
              ...
              {(moves < bestScore.moves || (moves === bestScore.moves && time <= bestScore.time)) && (
                <div className="bg-yellow-500/20 backdrop-blur-sm rounded-xl px-6 py-3 mb-6 inline-block border border-yellow-500/30">
                  <span className="text-yellow-300 text-xl font-bold">🏆 Новый рекорд!</span>
                </div>
              )}
              <div>
                <button
